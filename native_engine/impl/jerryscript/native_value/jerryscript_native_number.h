...
#ifndef FOUNDATION_ACE_NAPI_NATIVE_ENGINE_IMPL_JERRYSCRIPT_NATIVE_VALUE_JERRYSCRIPT_NATIVE_NUMBER_H
#define FOUNDATION_ACE_NAPI_NATIVE_ENGINE_IMPL_JERRYSCRIPT_NATIVE_VALUE_JERRYSCRIPT_NATIVE_NUMBER_H

#include "jerryscript_native_value.h"

class JerryScriptNativeNumber : public JerryScriptNativeValue, public NativeNumber {
public:
